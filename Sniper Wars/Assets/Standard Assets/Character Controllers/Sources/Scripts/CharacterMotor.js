...
// The current global direction we want the network character to move in.
@System.NonSerialized
var networkInputMoveDirection : Vector3 = Vector3.zero;
...
private function UpdateFunction () {
    ...
    // Disable the object tree if this isn't ours
...
function OnSerializeNetworkView(stream : BitStream, 
    ...
    stream.Serialize(networkInputMoveDirection);
}
...
private function ApplyInputVelocityChange (velocity : Vector3) {	
    if (!canControl)
		inputMoveDirection = networkInputMoveDirection;
	else 
        networkInputMoveDirection = inputMoveDirection;
