/*
 * This code was taken from the Unity wiki. Credit goes to Forest Johnson (Yoggy) for the
 *  original script and to Xyber for converting it to C#.
 *  
 *  URL: http://wiki.unity3d.com/index.php?title=TimeBasedTrailRenderer
 */
